      ...
      <div style={{ width: '100%', maxWidth: 400, animation: 'fadeUp 0.28s ease both', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <button onClick={() => navigate('/dashboard')} style={{
            ...
            gap: 10, cursor: 'pointer', marginBottom: 10,
          ...
          <button
            ...
            style={{
              width: '100%', padding: '10px', borderRadius: 8, background: '#24292e',
              border: '1px solid #24292e', color: '#fff', fontSize: 14,
              fontWeight: 500, display: 'flex', alignItems: 'center', justifyContent: 'center',
              gap: 10, cursor: 'pointer', marginBottom: 18,
              transition: 'background 0.18s, box-shadow 0.18s', fontFamily: 'inherit',
            }}
            onMouseEnter={e => { e.currentTarget.style.background = '#1a1f24'; e.currentTarget.style.boxShadow = '0 2px 8px rgba(0,0,0,0.2)' }}
            onMouseLeave={e => { e.currentTarget.style.background = '#24292e'; e.currentTarget.style.boxShadow = 'none' }}
          >
